                  ...
                  <tr key={item.id} className="group hover:bg-[#D4AF37]/[0.02] transition-colors">
                    ...
                    <td className="px-10 py-8 text-right">
                      <div className="flex items-center justify-end space-x-4">
                        <button onClick={() => onEdit(item)} className="p-3 text-zinc-500 hover:text-[#D4AF37] transition-all rounded-xl active:scale-90"><Edit2 size={16} /></button>
                        <button onClick={() => onDelete(item.id)} className="p-3 text-zinc-500 hover:text-rose-500 transition-all rounded-xl active:scale-90"><Trash2 size={16} /></button>
                      </div>
                    </td>
                  </tr>
                ))}
